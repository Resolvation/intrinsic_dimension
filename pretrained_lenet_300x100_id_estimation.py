...
def main():
    ...
    for d in range(50, 400, 50):
        ...
        writer = SummaryWriter("./logs/Pretrained_LeNet_300_100_ID_estimation/{:}".format(d))

        model = LeNet_300_100_ID(d).to(device)
        ...
        save(model, "Pretrained_LeNet_300_100_ID_estimation/{:}".format(d))
        writer.close()
        del model
